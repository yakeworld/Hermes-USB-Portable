...
- 用户要求撰写或修改**竞赛/大赛项目申报书**（如数据要素×大赛、数智教育大赛等）
- 涉及 **Synthos 作为申报主体**的竞赛材料
- 需要填写 **DOCX 表格模板 + 长篇文字段落**
- 需要制作**路演PPT**

> ⚠️ 不覆盖政府科技专项申报（创新联合体、重大科技攻关项目）。这类申报属于 `institutional-reform` 技能中的 `references/gov-grant-innovation-consortium.md`，要求不同：
> - 政府专项要求联合体≥6家、市域内≥50%、企业≥50%
> - 资金为研发经费支持（≤20%、上限200万），非奖金
> - 周期至少3年，有明确产业化指标
> - B类需全国重点实验室/省实验室/研究型医院牵头
